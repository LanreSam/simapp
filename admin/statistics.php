...
<?php include('includes/admin-header.php');?>
                        ...
                        <ul class="navbar-nav flex-column mt-4">
                            ...
                            <li class="nav-item"><a href="statistics.php" class="nav-link text-white p-3 mb-2 current"><img src="img/chart.png" width="30" class="mr-3"> Statistics</a></li>
